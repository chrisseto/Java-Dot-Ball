...
public class EnemyController
{
	...
	boolean checkCollision(PlayerBall player)
	{
	...
	void checkCollisionPowerUps(ArrayList<? extends PowerUpField> powerUps, ArrayList<? extends PlayerMod> playerMods)
	{
	...
	{
		for (float i =0; i<(2*PI); i+=(QUARTER_PI/2))
		{
			reds.add(new EnemyBall(x+radius*cos(i), y+radius*sin(i)));
		}
	}
}
